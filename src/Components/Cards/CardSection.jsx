      ...
      <div className="flex flex-col gap-10 md:grid md:grid-cols-3 md:gap-3 h-[50%] ">
        <Link href={"/car"}>
          <Card
            ...
            description={"Get the wheels you need, when you need them"}
          />
        </Link>
        <Link href={"/drivers"}>
          <Card
            ...
            title={"Hire A Driver"}
            color={"#fd8d14"}
            description={"Your personal chauffeur, anytime, anywhere"}
          />
        </Link>
        <Link href={""}>
          <Card
            ...
            description={"Master the road with expert driving lessons"}
          />
        </Link>
      </div>
    </section>
